...
<div style="margin-top:50px; width:500px">
	<springform:form method="post" action="editairconditionerdetails"
	...
	<springform:input path="productId" type="hidden"
		...
		<div class="form-group">
			<springform:input path="airconditioner_type" class="form-control"
				placeholder="enter type"  />
		</div>
		
		<div class="form-group">
			<springform:input path="airconditioner_powersavings_rating" class="form-control"
