...
<div style="width:500px;flex:2">
	<table class="table table-bordered table-striped">
		...
		<tbody>
			...
			<tr>
				<td><a href="${contextPath }/vendor/editrefrigeratordetails/${refrigerator.productId }"><button
						class="btn btn-success">edit</button></a></td>
			
			<td><a href="${contextPath }/vendor/deleteproduct/${refrigerator.productId }"><button
