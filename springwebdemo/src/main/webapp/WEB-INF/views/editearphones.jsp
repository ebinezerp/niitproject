...
<div style="margin-top:50px; width:500px">
	<springform:form method="post" action="editearphonesdetails"
		modelAttribute="earphones" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<springform:radiobutton path="microphone" value="true" />True
			<springform:radiobutton path="microphone" value="false" />False
		</div>
