...
<div style="margin-top:50px; width:500px">
	<springform:form method="post" action="editpowerbankdetails"
		modelAttribute="powerbank" enctype="multipart/form-data">
		...
		<div class="form-group">
			<springform:input path="batteryType" class="form-control"
				placeholder="enter battery Type"  />
		</div>
		<div class="form-group">
			<springform:input path="numberOFOutputs" class="form-control"
				placeholder="enter number oF outputs"  />
		</div>
		<div class="form-group">
			<springform:input path="powerOutput" class="form-control"
