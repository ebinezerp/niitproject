...
<div style="flex:2">
<img alt="image" style="width:500px" src='<spring:url value="/resources/images/products/${laptop.productId }.jpg"></spring:url>'>
</div>
<div style="width:500px;flex:2">
	<table class="table table-bordered table-striped">
		...
		<tbody>
			<tr>
				<td>Brand</td>
				<td><c:out value="${laptop.product_brand }"></c:out></td>
			</tr>
			<tr>
				<td>Model</td>
				<td><c:out value="${laptop.product_model }"></c:out></td>
			</tr>
			<tr>
				<td>Color</td>
