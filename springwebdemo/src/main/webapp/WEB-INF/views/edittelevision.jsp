...
<div style="margin-top:50px; width:500px">
	<springform:form method="post" action="edittelevisiondetails"
		modelAttribute="television" enctype="multipart/form-data">
	...
	<springform:input path="productId" type="hidden"
		...
		<div class="form-group">
			<springform:input path="television_type" class="form-control"
				placeholder="enter type" />
		</div>
		<div class="form-group">
			<springform:input path="television_size" class="form-control"
		...
		<div class="form-group">
			<springform:input path="television_description" class="form-control"
