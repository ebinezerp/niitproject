...
<div style="flex:2">
<img alt="image" style="width:500px" src='<spring:url value="/resources/images/products/${shoe.productId }.jpg"></spring:url>'>
</div>
<div style="width:500px;flex:2">
	<table class="table table-bordered table-striped">
		...
		<tbody>
			<tr>
				<td>Brand</td>
				<td><c:out value="${shoe.product_brand }"></c:out></td>
			</tr>
			<tr>
				<td>Model</td>
				<td><c:out value="${shoe.product_model }"></c:out></td>
			</tr>
			<tr>
				<td>Color</td>
				<td><c:out value="${shoe.product_color }"></c:out></td>
			</tr>
			<tr>
				<td>gender</td>
				<td><c:out value="${shoe.gender }"></c:out></td>
			</tr>
			<tr>
				<td>shoetype</td>
				<td><c:out value="${shoe.shoetype }"></c:out></td>
			</tr>
			<tr>
				<td><a href="${contextPath }/vendor/editshoedetails/${shoe.productId }"><button
						class="btn btn-success">edit</button></a></td>
			
			<td><a href="${contextPath }/vendor/deleteproduct/${shoe.productId }"><button
