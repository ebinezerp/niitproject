...
<div style="margin-top:50px; width:500px">
	<springform:form method="post" action="editrefrigeratordetails"
		modelAttribute="refrigerator" enctype="multipart/form-data">
	...
	<springform:input path="productId" type="hidden"
		...
		<div class="form-group">
			<springform:input path="refrigerator_doors" class="form-control"
				placeholder="enter number of doors"  />
		</div>
		<div class="form-group">
			<springform:input path="refrigerator_powersavings_rating" class="form-control"
		...
		<div class="form-group">
			<springform:input path="refrigerator_description" class="form-control"
