...
<div style="flex:2">
<img alt="image" style="width:500px" src='<spring:url value="/resources/images/products/${ssd.productId }.jpg"></spring:url>'>
</div>
<div style="width:500px;flex:2">
	<table class="table table-bordered table-striped">
		...
		<tbody>
			<tr>
				<td>Brand</td>
				<td><c:out value="${ssd.product_brand }"></c:out></td>
			</tr>
			<tr>
				<td>Model</td>
				<td><c:out value="${ssd.product_model }"></c:out></td>
			</tr>
			<tr>
				<td>Color</td>
				<td><c:out value="${ssd.product_color }"></c:out></td>
			</tr>
			<tr>
				<td>storage</td>
				<td><c:out value="${ssd.storage }"></c:out></td>
			</tr>
			<tr>
				<td><a href="${contextPath }/vendor/editssddetails/${ssd.productId }"><button
						class="btn btn-success">edit</button></a></td>
			
			<td><a href="${contextPath }/vendor/deleteproduct/${ssd.productId }"><button
